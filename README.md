...
FRONT END: The front end will be developed using the Android-native Kotlin language to ensure optimal performance can be achieved.

BACK END: The back end will use Node.js to handle data retrieval from weather APIs and other server-side logic.
